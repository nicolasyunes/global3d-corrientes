# Delta for supabase-connectivity

Typed Supabase client factory with fail-fast environment validation and a connectivity smoke check. Greenfield — all requirements are ADDED.
